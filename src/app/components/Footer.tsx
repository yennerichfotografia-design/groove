...
export function Footer() {
  ...
  return (
    <footer className="relative text-black" style={{ background: 'var(--groove-accent)', padding: 'var(--space-section-y) 0' }}>
        ...
        <div className="md:hidden">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/in/matias-yennerich-b37bb1206/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center border border-black/10 rounded-full text-black/60 hover:text-white hover:bg-black transition-all duration-200" aria-label="LinkedIn">
                <Linkedin size={14} />
              </a>
              <a href="https://www.instagram.com/gdstudio.ar/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center border border-black/10 rounded-full text-black/60 hover:text-white hover:bg-black transition-all duration-200" aria-label="Instagram">
                <Instagram size={14} />
              </a>
              <a href="https://www.behance.net/zozobracontenidos" target="_blank" rel="noopener noreferrer" className="w-9 h-9 flex items-center justify-center border border-black/10 rounded-full text-black/60 hover:text-white hover:bg-black transition-all duration-200" aria-label="Behance">
          ...
          <div className="grid grid-cols-3 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-4 mb-6">
                <a href="https://www.linkedin.com/in/matias-yennerich-b37bb1206/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-black/10 rounded-full text-black/60 hover:text-white hover:bg-black transition-all duration-200" aria-label="LinkedIn"><Linkedin size={16} /></a>
                <a href="https://www.instagram.com/gdstudio.ar/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-black/10 rounded-full text-black/60 hover:text-white hover:bg-black transition-all duration-200" aria-label="Instagram"><Instagram size={16} /></a>
                <a href="https://www.behance.net/zozobracontenidos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-black/10 rounded-full text-black/60 hover:text-white hover:bg-black transition-all duration-200" aria-label="Behance">
